...
- `trade_type` — `"acquisition"` if the director's holding increased,
  `"disposal"` if it decreased.
...
- `quantity` — the number of securities acquired or disposed. Always a
  positive integer regardless of direction.
